/* ============================================================
   FORWARD BEND HANDLERS - 1 METER DISTANCE
============================================================ */

import { updateForwardBend, finishForwardBendTest, forwardBendFinalScore as calcScore, resetForwardBendState, startForwardBendTest as startTest } from './forward-bend-scoring-logic-1meter.js';
