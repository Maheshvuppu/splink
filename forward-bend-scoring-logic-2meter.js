/* ============================================================
   FORWARD BEND SCORING LOGIC - 2 METER DISTANCE
   
   Contains:
   - 2m-specific forward bend scoring
   - Hip-thoracic ratio calculation
   - Form quality assessment for 2m
============================================================ */
...
export function updateForwardBend(lm, onRepSpeak, onTestFinish, inCorrectPosition = true, exercise = 'forward-bend', captureFrame = null) {
    ...
    const depthTolerance = Math.max(0.025, (standingHeight || 1) * 0.08);
