/* ============================================================
   HIGH KNEE MARCH SCORING LOGIC - 2 METER DISTANCE
   
   Contains:
   - 2m-specific high knee rep counting
...
export function updateHighKneeMarch(lm, onRepSpeak, onTestFinish, inCorrectPosition = true, exercise = 'high-knee', captureFrame = null) {
    ...
    // 2m thresholds - original values
    const UP_NORM = 0.05;
    const DOWN_NORM = 0.02;
    const UP_BEND = 20;
    const DOWN_BEND = 12;
    const COUNT_COOLDOWN_MS = 200;
